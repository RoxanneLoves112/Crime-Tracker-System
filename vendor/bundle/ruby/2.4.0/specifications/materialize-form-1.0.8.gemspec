...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<bundler>.freeze, ["~> 1.12", ">= 1.12.5"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 11.1", ">= 11.1.2"])
    else
      s.add_dependency(%q<bundler>.freeze, ["~> 1.12", ">= 1.12.5"])
      s.add_dependency(%q<rake>.freeze, ["~> 11.1", ">= 11.1.2"])
    end
  else
    s.add_dependency(%q<bundler>.freeze, ["~> 1.12", ">= 1.12.5"])
    s.add_dependency(%q<rake>.freeze, ["~> 11.1", ">= 11.1.2"])
