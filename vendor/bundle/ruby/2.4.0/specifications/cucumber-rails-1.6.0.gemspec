...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capybara>.freeze, [">= 1.1.2", "< 4"])
      s.add_runtime_dependency(%q<cucumber>.freeze, [">= 3.0.2", "< 4"])
      s.add_runtime_dependency(%q<nokogiri>.freeze, ["~> 1.8"])
      s.add_runtime_dependency(%q<railties>.freeze, [">= 4", "< 6"])
      ...
      s.add_development_dependency(%q<builder>.freeze, [">= 3.1.0", "< 4"])
      ...
      s.add_dependency(%q<capybara>.freeze, [">= 1.1.2", "< 4"])
      s.add_dependency(%q<cucumber>.freeze, [">= 3.0.2", "< 4"])
      s.add_dependency(%q<nokogiri>.freeze, ["~> 1.8"])
      s.add_dependency(%q<railties>.freeze, [">= 4", "< 6"])
      ...
      s.add_dependency(%q<builder>.freeze, [">= 3.1.0", "< 4"])
